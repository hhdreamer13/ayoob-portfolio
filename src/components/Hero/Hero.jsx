      ...
      <div className="relative grid grid-cols-1 lg:grid-cols-4">
        <div className="col-span-1 lg:col-span-3">
          <article className="lg:ml-16">
            <h1 className="bg-gradient-to-r from-slate-400 to-white bg-clip-text py-2 font-['Expletus_Sans'] text-8xl font-extrabold text-transparent md:py-4 md:text-8xl lg:mt-10">
              Ayoob Salari
            </h1>
        ...
        <div className="absolute -top-10 left-0 -z-30 w-full sm:left-20 sm:w-3/4 md:left-60 md:w-1/2 lg:top-0 lg:top-2 lg:left-1/2 lg:w-1/2">
          <BackgroundAnimation />
        </div>
      </div>
    </div>
